...
public final class AuthDao_Impl implements AuthDao {
  ...
  public AuthDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR IGNORE INTO `user_table` (`userId`,`username`,`password`) VALUES (nullif(?, 0),?,?)";
      }
  ...
  @Override
  public Object signUp(final User user, final Continuation<? super Unit> continuation) {
  ...
  public Object login(final String username, final String password,
    ...
    final String _sql = "SELECT * FROM user_table WHERE username = ? AND password = ?";
      ...
      public User call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new User(_tmpUserId,_tmpUsername,_tmpPassword);
          } else {
            _result = null;
          }
          return _result;
